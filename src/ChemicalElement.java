public class ChemicalElement {
    ...
    /**
     * Generates an object to hold data (taken from a file) on the properties of various chemical elements
     * @param element full element name
     * @param number atomic number
     * @param symbol 1 or 2 character symbol representing the scientific name of the element
     * @param weight atomic weight of the given element
     * @param boil boil temperature (may not be used)
     * @param melt melting temperature (may not be used)
     * @param density atomic density
     * @param vapor vaporization temperature
     * @param fusion fusion temperature
     */
    ...
    /**
     * Default contructor of ChemicalElement
     */
